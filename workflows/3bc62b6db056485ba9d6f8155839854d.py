...
dag_config_0 = {'start_date': '2023-05-17', 'schedule_interval': None, 'catchup': False, 'dag_id': '3bc62b6db056485ba9d6f8155839854d'}
...
with DAG(**dag_config) as dag:
    task_1 = Task(
        ...
        piece={'name': 'SimpleLogPiece', 'source_image': 'ghcr.io/tauffer-consulting/default_domino_pieces_tests:0.0.2-group0', 'repository_id': 56},
